...
**Freshness.** Verified against canonical main `13d3777235f7fb8db701d76c6637197e45e72be3`, 2026-08-19. Current state is owned by [`current-state.md`](current-state.md) — this map routes to it and does not restate it or its freshness contract. **Additive B4 clause:** the §1 task-context-pack row and the §2 `B0 … B6` lifecycle correction are verified against canonical main `3a1c986570e1e7aa767c89a031b64a6a39c7009a`, 2026-08-19; **the remainder of this map retains the `13d3777…` verification base**, which B4 did not reverify — expressly including the §1 `†` freshness note, whose claims about the intervening commits and about no fact being known-wrong B4 records as overtaken and routes to B5 rather than rewriting.
